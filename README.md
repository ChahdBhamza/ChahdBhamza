#  Hi, I’m **Chahd Ben Hamza**

### 🌟 About Me
I’m a **final-year Computer Science student** specializing in **Big Data & Data Analysis**, passionate about transforming massive datasets into **actionable insights** and exploring the intersection of **Artificial Intelligence** with large-scale data processing.  
I love building smart, practical solutions and sharing my work with the community.
...
<div align="center" style="display: flex; gap: 40px; flex-wrap: wrap; justify-content: center;">
  ...
  ">
    ...
    <p style="color: #c9d1d9;">
      <b>Secure personal data management platform</b> focused on privacy,
...
<p style="margin-top: 16px;">
  ...
  ">
    <h3>🥗 Dietopia</h3>
    <p style="color: #c9d1d9;">
  <b>An AI-powered full-stack nutrition platform</b> that delivers personalized,
  metabolically accurate meal plans while enabling intelligent meal discovery,
  ordering, and real-time data-driven user–admin workflows.
</p>
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=0:ff69b4,50:1f6feb,100:a371f7&height=2&section=footer"/>
</p>


<p align="center" style="color:#8b949e;">
  <i>Thanks for stopping by my GitHub! Let’s build something amazing together!</i>
</p>
